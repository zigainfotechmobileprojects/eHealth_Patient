...
class ServerError implements Exception {
  ...
  _handleError(DioException error) {
    if (error.response?.statusCode == 401 &&
      ...
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['phone_code'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['dob'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['dob'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['gender'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['gender'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
      ...
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['time'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['date'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['date'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['payment_type'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['payment_type'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['review'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['review'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
      ...
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['appointment_id'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
      ...
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['medicines'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
    } else if (error.response!.data['errors']['old_password'] != null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['old_password'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
        ...
        null) {
      Fluttertoast.showToast(
          msg: '${error.response!.data['errors']['password_confirmation'][0]}',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM);
      return;
